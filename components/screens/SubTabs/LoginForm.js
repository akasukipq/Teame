...
import { View, StyleSheet, TextInput, Button, Alert, TouchableOpacity, AsyncStorage } from 'react-native';
            ...
            <View style={styles.container1}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    <View style={{ flexDirection: "row", paddingTop: 20, alignItems: "center" }}>
                        <Radio selected={this.state.remember} ref="remme" color="#F3C537" selectedColor="#F3C537" onPress={() => {
                            this.setState({
                ...
                <TouchableOpacity style={styles.button}
                    onPress={() => {
                        ...
                        if (this.state.remember) {
                            AsyncStorage.setItem('remember', this.state.remember == true ? 'true' : 'false');
                        }
                    }}>
                    <Text>Đăng Nhập</Text>
                </TouchableOpacity>
